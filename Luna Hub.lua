...
if game:GetService("CoreGui"):FindFirstChild("LUNA GUI") then
	game:GetService("CoreGui"):FindFirstChild("LUNA GUI"):Destroy()
end
local DiscordLib = {}
...
local serv = win:Server("LUNA HUB","")
...
AutoFarm:Toggle("Auto Set Spawn Point", false, function(vu)
    AutoSetSpawn = vu
end)
...
if Old_World then
	AutoFarm:Toggle("Auto Second Sea", _G.AutoNewworld, function(vu)
		Auto_Newworld = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
AutoFarm:Toggle("Auto Farm Mastery Gun", false, function(vu)
	...
	if AutoarmMasteryGun and SelectToolWeapon == "" then
		DiscordLib:Notification("Auto Farm Mastery","SelectWeapon First","Okay")
	else
		FarmMasteryGun = vu
		if vu == false then
...
if New_World then
	AutoFarm:Toggle("Auto Quest Bartilo", false, function(vu)
		...
		elseif CheckBarto == true and SelectToolWeapon == "" then
	...
	AutoFarm:Toggle("Auto Evo Race", false, function(vu)
		...
		elseif CheckEvo == true and SelectToolWeapon == "" then
...
elseif New_World then
    ...
    Tp:Button("Hot and Cold Island", function()
        TP2(CFrame.new(-5956.76, 15.9518, -5094.42))
    end)
    ...
    Tp:Button("Ice Castle", function()
        TP2(CFrame.new(6439.79, 287.199, -6916.94))
    end)
	...
	Tp:Button("l'Église de Prophétie", function()
		TP2(CFrame.new(243.413, 1.36005, 1835.94))
	end)
...
elseif Three_World then
    ...
    Tp:Button("Haunted Castle", function()
        TP2(CFrame.new(-9515.07324, 142.130615, 5537.58398))
    end)

	Tp:Button("Sea of Treats", function()
		TP2(CFrame.new(-2045.35, 4.67528, -9907.57))
	end)

	Tp:Button("l'Église de Prophétie", function()
		TP2(CFrame.new(-11560.1, 49.1727, -7554.19))
	end)
	...
	pcall(function()
		while wait(.1) do
			if AutoStoreFruit then
				...
				if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Soul Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Control Fruit") then
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Control-Control")
                end
...
BuyItem:Button("Sky Jump", function()
...
Setting:Button("Copy Link Discord : Luna Hub", function()
	setclipboard("https://discord.gg/uDRpeVKXxx")
end)
    ...
    game:GetService("RunService").RenderStepped:Connect(function()
     pcall(function()
        ...
        Cemara.CameraShakeInstance.CameraShakeState = {FadingIn = 3, FadingOut = 2, Sustained = 0, Inactive = 1}
         ...
         Combat.activeController.hitSound = 0 
         Combat.activeController.increment = 3
         Combat.activeController.hitboxMagnitude = 150
         Combat.activeController:attack()
         Combat.activeController.currentAttackTrack = nil
         Combat.activeController.focusStart = 0 
         Combat.activeController.AutoRotate = false
         Combat.activeController.active = false 
         Combat.activeController.timeToNextBlock = 0 
         Combat.activeController.blocking = false 
            end
     end)
 end) 
 end)
...
Setting:Toggle("Fast Attack", false, function(vu)
    _G.FastAtttk = vu
end)
...
Misc:Toggle("Infinity Energy",false,function(value)
...
Misc:Toggle("Ctrl + Click to TP", false, function(vu)
	CTRL = vu
end)
...
function CheckLevel()
	...
	if Three_World then
		...
		elseif Lv == 2075 or Lv <= 2099 or SelectMonster == "Peanut Scout [Lv. 2075]" then
			...
			CFrameQ = CFrame.new(-2104.42188, 38.1041679, -10194.0439, 0.804114521, -4.21733795e-08, 0.594474435, -2.78098682e-08, 1, 1.08559249e-07, -0.594474435, -1.03826324e-07, 0.804114521)
			CFrameMon = CFrame.new(-2166.38477, 90.5294876, -10179.7754, -0.987936974, 2.98406917e-08, 0.154856399, 2.08254054e-08, 1, -5.9839337e-08, -0.154856399, -5.58925457e-08, -0.987936974)
		elseif Lv == 2100 or Lv <= 2124 or SelectMonster == "Peanut President [Lv. 2100]" then
			...
			CFrameQ = CFrame.new(-2104.42188, 38.1041679, -10194.0439, 0.804114521, -4.21733795e-08, 0.594474435, -2.78098682e-08, 1, 1.08559249e-07, -0.594474435, -1.03826324e-07, 0.804114521)
			CFrameMon = CFrame.new(-2071.98364, 90.531517, -10555.1455, -0.00996640418, -2.91116695e-08, -0.999950349, -4.03047338e-08, 1, -2.87114013e-08, 0.999950349, 4.00165838e-08, -0.00996640418)
		elseif Lv == 2125 or Lv <= 2149 or SelectMonster == "Ice Cream Chef [Lv. 2125]" then
			Ms = "Ice Cream Chef [Lv. 2125]"
			NameQuest = "IceCreamIslandQuest"
			QuestLv = 1
			NameMon = "Ice Cream Chef"
			CFrameQ = CFrame.new(-820.219727, 66.3829727, -10966.207, 0.813175619, -3.88680874e-08, -0.582018435, 5.24737631e-09, 1, -5.94500946e-08, 0.582018435, 4.52892976e-08, 0.813175619)
			CFrameMon = CFrame.new(-715.818237, 140.583588, -10848.8457, -0.110631809, -6.40644373e-08, 0.993861437, 2.73576095e-08, 1, 6.75054466e-08, -0.993861437, 3.46579228e-08, -0.110631809)
		elseif Lv == 2150 or Lv <= 2200 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then
			...
			CFrameQ = CFrame.new(-820.219727, 66.3829727, -10966.207, 0.813175619, -3.88680874e-08, -0.582018435, 5.24737631e-09, 1, -5.94500946e-08, 0.582018435, 4.52892976e-08, 0.813175619)
			CFrameMon = CFrame.new(-864.787781, 176.990326, -11133.5068, 0.337587982, 4.45867272e-08, -0.941293955, 5.16999554e-09, 1, 4.92216614e-08, 0.941293955, -2.14831282e-08, 0.337587982)
		end
	end
end
...
function CheckBossQuest()
	...
	if Three_World then
		...
		elseif SelectBoss == "Cake Queen [Lv. 2175] [Boss]" then
            ...
            QuestLvBoss = 3
            RewardBoss = "Reward:\n$30,000\n91,000,000 Exp."
            CFrameQBoss = CFrame.new(-820.219727, 66.3829727, -10966.207, 0.813175619, -3.88680874e-08, -0.582018435, 5.24737631e-09, 1, -5.94500946e-08, 0.582018435, 4.52892976e-08, 0.813175619)
            CFrameBoss = CFrame.new(-723.707, 381.565, -10987.8)
...
spawn(function()
    game:GetService("RunService").Stepped:Connect(function()
        if SafeMode or PlayerHunt or KillPlayer or AutoRainbow or AutoCitizen or AutoFarmBoss or FarmAllBoss or Elite or AutoThird or AutoBartilo or AutoRengoku or Auto_Bone or AutoEcto or AutoFarmObservation or Auto_Farm or FarmMasteryGun or FarmMasteryFruit or _G.Auto_indra_Hop or _G.Auto_Dark_Dagger_Hop or _G.AutoDonSwan_Hop or _G.Pole_Hop or Core or AutoEvoRace or TPChest or NextIsland or RaidSuperhuman or _G.AutoRaid or SelectFarm or Clip or AutoFarmSelectMonster then
